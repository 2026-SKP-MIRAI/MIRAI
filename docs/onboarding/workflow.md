...
git worktree add .worktree/000015-pdf-upload -b feat/15-pdf-upload    # 기능 구현
git worktree add .worktree/000023-parser-error -b fix/23-parser-error # 버그 수정
git worktree add .worktree/000031-interface-doc -b docs/31-interface-doc # 문서 작업
```
...
> 워크트리 디렉토리명과 `docs/work/active/` 폴더명을 동일하게 맞춘다. 예: 이슈 #15 → `.worktree/000015-pdf-upload`, `docs/work/active/000015-pdf-upload`
