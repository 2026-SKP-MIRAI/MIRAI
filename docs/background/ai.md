...
## 목적
프로젝트 배경 자료 보관. 의사결정 근거가 된 외부 분석·연구 문서.
팀원이 "왜 이렇게 결정했지?"를 이해할 때 참고하는 곳.
...
├── claude_code_creator_workflow.md      Claude Code 창시자(Boris Cherny) 워크플로우 13가지 방법
...
## 역할
- forward-looking 전략 문서는 docs/whitepaper/ 에 위치
- 이 디렉토리는 외부 자료·분석·근거 자료만
- 개인정보 포함 문서는 커밋 금지 (.gitignore 적용)
