...
## 완료 기준
- [x] Supabase + Prisma 초기화: `resumes` (resumeText, questions), `interview_sessions` (resumeId FK, questionsQueue, history, sessionComplete) 테이블
- [ ] RLS 정책 설정 — Phase 2(인증 도입 시) 예정, 현재 미구현
